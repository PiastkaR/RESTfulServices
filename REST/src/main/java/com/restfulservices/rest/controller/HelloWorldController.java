...
import com.restfulservices.rest.helloworld.HelloWorldBean;
...
public class HelloWorldController {
    ...
    @RequestMapping(method = RequestMethod.GET, path = "/hello-world/internationalized/no-header")
    public String helloWorldInternationalizedNoHeader() {
